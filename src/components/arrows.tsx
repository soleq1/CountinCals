export const Arrows = (props:any) =>{
    return(
        ...
        <button  className='plusSvg' onClick={() =>props.onPressUp()}>
...
<button  className='plusSvg' onClick={() =>props.onPressDown()}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-down-circle" viewBox="0 0 16 16">
